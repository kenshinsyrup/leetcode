package com.myleetcode.priority_queue.remove_duplicate_letters;

import java.util.*;

public class Solution {
    public String removeDuplicateLetters(String s) {
        // return removeDuplicateLettersByStack(s); // More efficient.
        return removeDuplicateLettersByPQ(s); // More intuitive if remeber the idea.
    }
