package com.myleetcode.dynamic_program.best_time_to_buy_and_sell_stock_iii;
...
class Solution {
    public int maxProfit(int[] prices) {
        ...
        return maxProfitByDPForK(prices, 2);
    }
    ...
    */
    private int maxProfitByDPForK(int[] prices, int K) {
        ...
        for (int k = 0; k <= K; k++) {
            ...
            dp[0][k][1] = Integer.MIN_VALUE; // Has Stock at hand. Impossible.
        }
